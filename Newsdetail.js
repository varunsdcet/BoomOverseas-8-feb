...
<Image style={{marginLeft :10,marginTop :10,height :25,width :25,resizeMode:'contain'}}
               ...
               <PowerTranslator style={{marginLeft : 15,marginTop:12,fontSize : 16,color :'white',fontFamily :'Poppins-Medium'}} text={'NewsDetail'} />
</View>
...
<PowerTranslator style={{fontSize : 13,color :'#4b4b4c',fontFamily :'Poppins-Medium'}} text={'INDIA'} />
<PowerTranslator style={{fontSize : 12,color :'#4b4b4c',fontFamily :'Poppins-Medium',marginRight :16}} text={'Posted on Jan 12, 2018'} />

</View>

<PowerTranslator style={{margin:8,fontSize : 18,color :'black',fontFamily :'Poppins-Medium'}} text={'What is Loreum Ipsum ?'} />
<Image style={{marginLeft :10,marginTop :10,height :125,width :window.width - 40,resizeMode:'contain'}}
               source={require('./logo.png')} />
<PowerTranslator style={{marginLeft:8,marginTop:10,fontSize : 14,color :'black',fontFamily :'Poppins-Regular'}} text={'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the ins Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the ins Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the ins'} />

<PowerTranslator style={{textDecoration :'underline',marginLeft:8,marginTop:1,fontSize : 14,color :'black',fontFamily :'Poppins-Regular'}} text={'Credit : https :stackoverflow.com'} />
