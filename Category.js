 ...
 likePost({ item, index }) {
  ...
  _renderItem = ({item,index}) => {
    ...
    return (
      ...
      <View style={{backgroundColor:'white',color :'white' , flex: 1 ,margin: 10, height: 130,borderRadius :12,width : window.width/3 - 10, shadowColor: '#000',
    shadowOffset: { width: 0, height: 1 },
    shadowOpacity: 0.6,
    shadowRadius: 2,
    elevation: 5 }}>
    <Image style={{margin : 10,height :90,width :window.width/3 - 30,marginLeft: 5,resizeMode:'contain'}}
                   source={require('./categ.png')} />
<PowerTranslator style={{margin:8,marginTop : - 8,alignSelf :'center',fontSize : 12,color :'black',fontFamily :'Poppins-Medium'}} text={'Industry'} />
     </View>
