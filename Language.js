...
this.props.navigation.navigate('SelectType')
  ...
  render() {
    ...
    return (
     ...
     <Text style = {{ fontFamily: "Poppins-Medium",marginLeft :15,marginTop :80,width : 170,fontSize : 30  ,color :'#261650'}}>

     Pick Your Language
     </Text>

     <FlatList style= {{marginTop :20,flexGrow:0}}
        ...
        />
        <Button
                  containerStyle={{margin : 15,padding:10, height:40, overflow:'hidden', borderRadius:20, backgroundColor: '#261650'}}
