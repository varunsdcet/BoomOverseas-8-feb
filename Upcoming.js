...
<PowerTranslator style={{alignSelf :'center',fontSize : 11,color :'#181818',fontFamily :'Poppins-Medium'}} text={'Jan 12 ,2018'} />
</View>
<View style = {{width : 100,height : 40,backgroundColor :'#f2f3f5', borderRadius :20,flexDirection :'column',padding :2}}>
...
<PowerTranslator style={{alignSelf :'center',fontSize : 11,color :'#181818',fontFamily :'Poppins-Medium'}} text={'Oman'} />
</View>

   </View>
   <PowerTranslator style={{marginLeft : - 65,marginTop : 5,fontSize : 13,color :'black',fontFamily :'Poppins-Medium'}} text={'Categories'} />
<View style = {{marginLeft : - 65,marginTop : 2,flexDirection :'row'}}>
<View style = {{flexDirection :'row'}}>
<Image style={{marginLeft :10,marginTop :10,height :8,width :8,resizeMode:'contain'}}
               source={require('./dot.png')} />
 <PowerTranslator style={{marginLeft : 5,marginTop : 4,fontSize : 13,color :'black',fontFamily :'Poppins-Medium'}} text={'Mason'} />
     </View>
     ...
     <Image style={{marginLeft :10,marginTop :10,height :8,width :8,resizeMode:'contain'}}
      ...
      <Image style={{marginLeft :10,marginTop :10,height :8,width :8,resizeMode:'contain'}}
       ...
       <PowerTranslator style={{marginLeft : 5,marginTop : 4,fontSize : 13,color :'black',fontFamily :'Poppins-Medium'}} text={'Mason'} />
        ...
        <PowerTranslator style={{alignSelf : 'flex-end',marginLeft : 20,marginTop : 6, fontSize : 11,color :'black',fontFamily :'Poppins-Medium'}} text={'+ 4 More'} />
                </View>
            </View>
