...
this.props.navigation.navigate('SavedJob')
 ...
 likePost({ item, index }) {
  ...
  _renderItem = ({item,index}) => {
    ...
    shadowRadius: 2,
    elevation: 5 }}>
    <Image style={{position:'absolute',right : 10,height :25,width :25,resizeMode:'contain'}}
...
<Image style={{marginLeft :10,marginTop :10,height :25,width :25,resizeMode:'contain'}}
               ...
               <PowerTranslator style={{marginLeft : 15,marginTop:12,fontSize : 16,color :'white',fontFamily :'Poppins-Medium'}} text={'SavedJob'} />
</View>
