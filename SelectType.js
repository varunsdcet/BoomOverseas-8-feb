...
this.props.navigation.navigate('JobDetail')
 ...
 componentWillMount() {
  ...
  render() {
    ...
    <PowerTranslator style={styles.colord} text={'Choose Your Option'} />

    <TouchableOpacity

        onPress={() => this.resPress()}
      >
    <View style = {{marginTop : 15,marginLeft :30,width :window.width -60, height:40, overflow:'hidden', borderRadius:20, backgroundColor: '#261650'}}>
     <PowerTranslator style={{textAlign :'center',fontFamily: "Poppins-Medium",padding :12 ,color :'white'}} text={'Job Seeker'} />
    </View>
    ...
    <View style = {{marginTop : 15,width :window.width-60,marginLeft:30, height:40, borderRadius:20, backgroundColor: '#261650'}}>
     <PowerTranslator style={{textAlign :'center',fontFamily: "Poppins-Medium",padding :12 ,color :'white'}} text={'Job Provider'} />
    </View>
    </TouchableOpacity>
