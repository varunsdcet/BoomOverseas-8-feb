...
this.props.navigation.navigate('News')
 ...
 likePost({ item, index }) {
  ...
  _renderItem = ({item,index}) => {
    ...
    <PowerTranslator style={{margin:8,fontSize : 16,color :'black',fontFamily :'Poppins-Medium'}} text={'Urgent Requirement in Neurologist'} />

      <PowerTranslator style={{margin:8,marginTop:-8,fontSize : 12,color :'black',fontFamily :'Poppins-Regular'}} text={'Max Hospital'} />
      <PowerTranslator style={{marginLeft : window.width - 166,margin:8,marginTop:-15,fontSize : 12,color :'black',fontFamily :'Poppins-Regular'}} text={'02/02/2018'} />
