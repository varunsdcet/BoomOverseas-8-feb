...
this.props.navigation.navigate('Otp')
     ...
     <Image style= {{resizeMode:'contain',marginTop : 30 ,marginLeft : window.width/2 - 100 ,width : 200 ,height : 150}}
         ...
         <TextInput   style={{marginTop :3 ,marginLeft : 20,width : window.width - 40 ,height : 40 ,borderBottomWidth :1}}
                                 ...
                                 onChangeText={(text) => this.setState({username:text})}
                                  ...
                                  <PowerTranslator style={{fontFamily: "Poppins-Medium",fontSize : 13,color :'#333333',marginTop : 12 ,marginLeft :20,width : window.width -40 ,height : 20}} text={'PASSWORD'} />
                                  <TextInput   style={{marginTop :3 ,marginLeft : 20,width : window.width - 40 ,height : 40 ,borderBottomWidth :1}}
                                                          ...
                                                          onChangeText={(text) => this.setState({username:text})}
                                                           ...
                                                           <Button
                                                                     containerStyle={{marginTop : 7,marginLeft : window.width - 160,padding:10, height:40, overflow:'hidden', backgroundColor: '#ffffff'}}
                                                                      ...
                                                                      style={{fontSize: 12, color: 'black',fontFamily: "Poppins-Regular"}}
      ...
      <PowerTranslator style={{fontFamily: "Poppins-Medium",fontSize : 15,color :'black',marginTop : 15 ,marginLeft :17,width : window.width -30 ,height : 30}} text={'OR SIGIN WITH'} />


      <View style={{borderRadius:22,height:40, backgroundColor: '#261650',backgroundColor: '#284ca0',width:window.width-30,marginLeft : 15,marginTop : 9,flexDirection :'row'}}>
  ...
  <PowerTranslator style={{fontFamily: "Poppins-Medium",fontSize : 15,color :'white',padding :11 ,marginLeft :30,width : window.width -30 ,height : 28}} text={'CONTINUE WITH FACEBOOK'} />


                        </View>


                        <View style={{borderRadius:22,height:40, backgroundColor: '#e04a39',width:window.width-30,marginLeft : 15,marginTop : 15,flexDirection :'row'}}>
                    ...
                    <PowerTranslator style={{fontFamily: "Poppins-Medium",fontSize : 15,color :'white',padding :11 ,marginLeft :26,width : window.width -30 ,height : 28}} text={'CONTINUE WITH GOOGLE'} />
